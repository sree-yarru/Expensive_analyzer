...
# --- Unified Entry Point for Cloud Run Jobs and Cloud Functions ---
def run_agent(request=None):
    """
    Triggered by running the script directly or via an HTTP request.
    """
    print(f"📧 Financial Agent triggered at {datetime.now()}")
